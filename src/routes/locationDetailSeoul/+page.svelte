...
<body>
    <div class="locationDetail">
        <nav class="selectList">
            <ul>
                <li><a href="../Place?name=서울">명소</a></li>
                <li><a href="../Food?name=서울">음식점</a></li>
                <li><a href="../Cafe?name=서울">카페</a></li>
        ...
        <div class="LogMoment">
            <ul>
                <li class="LogMoment">
                    <h1>트래블로그</h1>
                    <a href="../travelLog?region=서울"><button>더보기</button></a>
                </li>
                {#each posts.filter(post => post.region === "서울").slice(0, 4) as post}
                    <li>
